...
st.title("Retention Strategies and Recommendations")
...
with col2:
    ...
    fig.update_layout(
        title=dict(text="Churn Rate by Tenure", font=dict(color='#ffffff', size=16)),
        plot_bgcolor='rgba(0,0,0,0)',
        paper_bgcolor='rgba(0,0,0,0)',
        font=dict(color='#ffffff'),
...
st.subheader("Business Impact and ROI")
...
st.subheader("Retention Goals and Targets")
...
with col1:
    ...
    <div class="strategy-card">
        ...
        <div style="margin-top: 0.5rem;">
            <span class="strategy-impact impact-high">Annual Savings: ₹{annual_savings:,.0f}</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
with col2:
    ...
    <div class="strategy-card">
        ...
        <div style="margin-top: 0.5rem;">
            <span class="strategy-impact impact-high">+₹{per_customer_increase:,} per customer</span>
        </div>
    </div>
    """, unsafe_allow_html=True)
